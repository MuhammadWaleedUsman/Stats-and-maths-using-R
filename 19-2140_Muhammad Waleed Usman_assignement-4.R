...
summary(l1model) #summary of model1
summary(l2model) #summary of model2
summary(l3model) #summary of model3
...
summary(q1model) #summary of model1
summary(q2model) #summary of model2
summary(q3model) #summary of model3
...
summary(c1model) #summary of model1
summary(c2model) #summary of model2
summary(c3model) #summary of model3
